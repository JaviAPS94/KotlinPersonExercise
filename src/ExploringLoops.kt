fun main(args: Array<String>) {
    ...
    people[1] = KotlinPerson(1, "Mr", "James", "Apple", null)
    people[2] = KotlinPerson(2, "Miss", "Sophie", "Orange", null)
    people[3] = KotlinPerson(3, "Mrs", "Anita", "Pineapple", null)
    people[4] = KotlinPerson(4, "Mr", "Darren", "Banana", null)
